...
// include("newlogin.php")
		...
		if($total!=0){
			...
			while(((($result = mysqli_fetch_assoc($data))&&($result_1 = mysqli_fetch_assoc($data_1)))||(($result_3 = mysqli_fetch_assoc($data_3)))&&($result_4 = mysqli_fetch_assoc($data_4)))||($result_2 = mysqli_fetch_assoc($data_2))){
				if((($Enusername==$result['username'])&&($Enpass==$result['password']))&&(($Enusername!="")&&($Enpass!=""))){
...
<body  bgColor="#c9c9c9">
    <!-- <h1>hi</h1> -->
        <form method="POST" action="newsellpage.php">
            <div class="div1">
            ...
            <div class="div2">
                ...
                <input class="div2i2" type="text" name="user_phno_dsb" disabled value="<?php echo $result['phoneno'];?>"><br>
...
// echo "User Found.LogIn Successfull.  :)".$total;
                    ...
                    if((($Enusername==$result_2['username'])&&($Enpass==$result_2['password']))&&(($Enusername!="")&&($Enpass!=""))){
